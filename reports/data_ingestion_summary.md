...
Generated at: `2026-07-09 17:36:48`
...
- Rows: `1,969`
- Columns: `14`
- Column names: `date, wm_yr_wk, weekday, wday, month, year, d, event_name_1, event_type_1, event_name_2, event_type_2, snap_CA, snap_TX, snap_WI`

Top columns by null count:

| column | null_count | null_pct |
|---|---:|---:|
| event_type_2 | 1,964 | 99.75% |
| event_name_2 | 1,964 | 99.75% |
| event_name_1 | 1,807 | 91.77% |
| event_type_1 | 1,807 | 91.77% |
| date | 0 | 0.00% |
| wm_yr_wk | 0 | 0.00% |
| year | 0 | 0.00% |
| month | 0 | 0.00% |
...
- Rows: `6,841,121`
- Columns: `4`
- Column names: `store_id, item_id, wm_yr_wk, sell_price`
